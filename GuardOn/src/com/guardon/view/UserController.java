...
@Async
 ...
 public String option(HttpServletRequest request) throws Exception{
	 String autoLogout=String.valueOf(optionService.getAutoLogout()); 
	 String loginFailedCount= String.valueOf(optionService.getLoginFailedCount());
	 String otpTimeLimit = String.valueOf(optionService.getOtpTimeLimit());
	 String pwdLength = String.valueOf(optionService.getPwdLength());
